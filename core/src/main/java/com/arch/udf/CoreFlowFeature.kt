 ...
 * is not meant for direct implementation by consumers but is used by [StandardFlowFeature] and [ViewModelFlowFeature].
 *
 ...
 */
internal interface CoreFlowFeature<STATE : Any, EVENT : Any, ACTION : Any, RESULT : Any, EFFECT : Any> :
